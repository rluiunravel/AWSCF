...
/usr/bin/wget http://preview.unraveldata.com/unravel/staging-RPM/4.2.5/unravel-4.2-1095.x86_64.EMR.rpm.20180202T2121Z
...
# install unravel rpm
/usr/bin/rpm  -U unravel-4.2-1095.x86_64.EMR.rpm.20180202T2121Z
